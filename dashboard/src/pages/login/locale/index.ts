const i18n = {
  'en-US': {
    'login.form.title': 'Login to Likit Dashboard',
    'login.form.subtitle': 'Likit is the best Baas for like',
  ...
  'zh-CN': {
    'login.form.title': '登录 Likit Dashboard',
    'login.form.subtitle': 'Likit 是最棒的点赞 Baas',
